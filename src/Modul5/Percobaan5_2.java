...
public class Percobaan5_2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MessageFormat.format("NIlai tertinggi adalah {0} berada di index {1}", dumyBest,
                getIndex(data, dumyBest)));
        System.out.println(MessageFormat.format("NIlai terendah adalah {0} berada di index {1}", dumyKec,
                getIndex(data, dumyKec)));
